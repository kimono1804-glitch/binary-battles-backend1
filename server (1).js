...
// For Vercel, database path needs to be in /tmp
const dbPath = process.env.VERCEL ? '/tmp/competition.db' : './competition.db';
    ...
    res.json({
        ...
        endpoints: {
            admin: {
                ...
                teams: 'GET /admin/teams',
                createTeam: 'POST /admin/teams/create',
                deleteTeam: 'DELETE /admin/teams/:id',
                leaderboard: 'GET /admin/leaderboard',
                activities: 'GET /admin/activities',
                stats: 'GET /admin/stats'
            },
            team: {
                login: 'POST /team/login',
                problems: 'GET /problems',
                problemDetails: 'GET /problems/:id',
                submit: 'POST /submit',
                progress: 'GET /team/:id/progress'
            }
        }
    });
});
